...
import { Plus, Minus, ShoppingCart, Clock, Search, Utensils, X } from 'lucide-react'
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
function RestaurantSearchPage() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    const filtered = allRestaurants.filter((r) => r.restaurantName.toLowerCase().includes(query))
    ...
    <div className="min-h-screen bg-muted/20 flex flex-col items-center">
      ...
      <main className="container mx-auto px-4 py-12 flex-grow flex flex-col items-center text-center">
        ...
        <p className="text-lg text-muted-foreground mb-8">
          Digite o nome do restaurante ou descubra novos lugares abaixo.
        </p>
                ...
                <Card className="hover:shadow-lg transition-shadow duration-300 flex flex-col h-full">
                  <CardContent className="p-0">
                    <div className="relative h-40 w-full">
                      <Image
                        src={getBannerUrl(resto) || "/placeholder.svg"}
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold mb-2">
                        Dados para {restaurant?.delivery ? "Entrega" : "Retirada"}
                      </h3>
                      <div className="space-y-2">
                ...
                <DialogFooter className="flex-col !justify-start items-stretch gap-4 pt-4 border-t">
                  ...
                  <Button
                    ...
                    disabled={
                      cart.length === 0 ||
                      !customerName ||
                      (restaurant?.delivery && !deliveryAddress) ||
                      !paymentMethod ||
                      !isRestaurantOpen
                    }
                  >
  ...
  return (
    <div className="min-h-screen bg-muted/20 flex items-center justify-center">
      <div className="text-center">
        <Utensils className="h-16 w-16 text-primary mb-4 mx-auto animate-pulse" />
